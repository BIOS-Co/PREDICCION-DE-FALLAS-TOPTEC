...
export default function Landing() {
  ...
  return (
    <React.Fragment>
      {/* <Preloader></Preloader> */}
      <div className='container-fluid vw-100 min-h- p-0 position-relative ps-0 pe-0 ps-sm-2 pe-sm-2 ps-md-3 pe-md-3 ps-lg-4 pe-lg-4 ps-xl-4 pe-xl-4 ps-xxl-4 pe-xxl-4'>
