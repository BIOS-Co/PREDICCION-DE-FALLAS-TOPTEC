  ...
  return (
    <React.Fragment>
      ...
      <div className='row gx-4 d-flex flex-wrap flex-row flex-sm-row flex-md-row flex-lg-row flex-xl-row flex-xxl-row justify-content-between justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between align-items-center align-self-center align-self-xxl-center ms-1 me-1'>
        ...
        <div className='col-auto col-sm-auto col-md-auto col-lg-auto col-xl-auto col-xxl-auto flex-grow-1 gap-1 d-flex flex-row justify-content-end justify-content-sm-end justify-content-md-end justify-content-lg-end justify-content-xl-end justify-content-xxl-end align-items-center align-self-center mt-4 mt-sm-4 mt-md-0 mt-lg-0 mt-xl-0 mt-xxl-0'>
          <div className='row g-3 g-sm-3 g-md-2 g-lg-2 g-xl-2 g-xxl-2 d-flex flex-row justify-content-center align-items-center align-self-center'>
            ...
            <div className="col-auto">
              <button type='button'  onClick={descargarXLSX} className="btn btn-neumorphic- btn-primary-blue- d-flex flex-row justify-content-center align-items-center align-self-center"><i className='fa icon-download-file me-2'></i>
      ...
      <><div className='row mt-4 mt-sm-4 mt-md-4 mt-lg-4 mt-xl-5 mt-xxl-5'>
                ...
                <div className='col-10 mx-auto'>
                  ...
                  <div className='row gx-2 d-flex flex-row justify-content-end align-items-start align-self-start mt-2 mb-4'>
                    <div className='col-12 col-sm-12 col-md-auto col-lg-auto col-xl-auto col-xxl-auto'>
                      <button type='button' className="btn btn-neumorphic- btn-primary-blue- d-flex flex-row justify-content-center align-items-center align-self-center ps-5 pe-5" onClick={sendData} data-bs-target="#manual-characterization" aria-controls="manual-characterization">
        ...
        </div><><div className={`offcanvas offcanvas-bottom offcanvas-bottom- manual-characterization- ${showManualCharacterization ? 'show' : ''}`} tabIndex="-1" data-bs-backdrop="false" id="manual-characterization" aria-labelledby="manual-characterization" data-bs-scroll="false">
          ...
          <div className="offcanvas-body ps-2 pe-2 ps-sm-2 pe-sm-2 ps-md-3 pe-md-3 ps-lg-4 pe-lg-4 ps-xl-4 pe-xl-4 ps-xxl-4 pe-xxl-4">
        ...
        </div><div className={`offcanvas offcanvas-bottom offcanvas-bottom- relevance-characteristics- ${showRelevanceCharacteristics ? 'show' : ''}`} tabIndex="-1" data-bs-backdrop="false" id="relevance-characteristics" aria-labelledby="relevance-characteristics" data-bs-scroll="false">
              <div className="offcanvas-header pt-4 pb-4 ps-2 pe-2 ps-sm-2 pe-sm-2 ps-md-4 pe-md-4 ps-lg-4 pe-lg-4 ps-xl-4 pe-xl-4 ps-xxl-4 pe-xxl-4">
                <h2 className="m-0 ms-3 me-5 p-0 lh-sm fs-2- font-oswald-regular- text-uppercase text-start fw-bold tx-primary-blue- le-spacing-1-">
            ...
            </div><div className={`offcanvas offcanvas-bottom offcanvas-bottom- import-characterization- ${showImportCharacterization ? 'show' : ''}`} tabIndex="-1" data-bs-backdrop="false" id="import-characterization" aria-labelledby="import-characterization" data-bs-scroll="false">
              <div className="offcanvas-header pt-4 pb-4 ps-2 pe-2 ps-sm-2 pe-sm-2 ps-md-4 pe-md-4 ps-lg-4 pe-lg-4 ps-xl-4 pe-xl-4 ps-xxl-4 pe-xxl-4">
                <h2 className="m-0 ms-3 me-5 p-0 lh-sm fs-2- font-oswald-regular- text-uppercase text-start fw-bold tx-primary-blue- le-spacing-1-">
            ...
            </div><div className='modal animated fade fast' id="upload-file" tabIndex="-1" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <div className='modal-content p-0 ps-4 pe-4'>
                  ...
                  <div className='modal-body position-relative'>
                    ...
                    <div className='row gx-2 d-flex flex-row justify-content-center align-items-start align-self-start mt-4 mb-2'>
                      <div className='col-auto'>
                        <button type='button' disabled={selectedFile === null} className="btn btn-neumorphic- btn-primary-blue- d-flex flex-row justify-content-center align-items-center align-self-center ps-5 pe-5" onClick={toggleImportCharacterization} data-bs-target="#import-characterization" aria-controls="import-characterization">
