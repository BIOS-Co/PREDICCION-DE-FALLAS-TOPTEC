...
const customNoOptionsMessage = (props) => (
  <NoOptionsMessage
    {...props}
    className="custom-no-options-message-internal-form-"
  >
    No registrado
  </NoOptionsMessage>
);
...
const customLoadingMessage = (props) => (
  <LoadingMessage {...props} className="custom-loading-message-internal-form-">
    Cargando
  </LoadingMessage>
);
...
export default function DataUpload() {
  React.useEffect(() => {
    ...
    let chartRelevanceCharacteristics = echarts.init(
      document.getElementById("relevance-characteristics-chart-")
    );
    ...
    const sortedData = dataRelevanceCharacteristics.sort(
      (a, b) => b.valueCharacteristics - a.valueCharacteristics
    );
            ...
            formatter: function (params, value) {
              ...
              if (paramsNameNumber > provideNumber) {
                for (var p = 0; p < rowNumber; p++) {
                  ...
                  if (p === rowNumber - 1) {
                    tempStr =
                      params.length > 6 ? params.slice(0, 12) + "..." : "";
                  } else {
                  }
                  newParamsName += tempStr;
                }
    ...
    $(window).on("resize", function () {
      if (
        chartRelevanceCharacteristics != null &&
        chartRelevanceCharacteristics !== undefined
      ) {
  ...
  const [showManualCharacterization, setShowManualCharacterization] =
    useState(false);
  const [showImportCharacterization, setShowImportCharacterization] =
    useState(false);
  const [showRelevanceCharacteristics, setShowRelevanceCharacteristics] =
    useState(false);
  ...
  React.useEffect(() => {
    ...
    if (
      showManualCharacterization ||
      showImportCharacterization ||
      showRelevanceCharacteristics
    ) {
  ...
  /**
   * Inicializador de paginación en las tablas
   */
  ...
  return (
    <React.Fragment>
      <div className="row gx-4 d-flex flex-wrap flex-row flex-sm-row flex-md-row flex-lg-row flex-xl-row flex-xxl-row justify-content-between justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between align-items-center align-self-center align-self-xxl-center ms-1 me-1">
        <div className="col-auto col-sm-auto col-md-auto col-lg-auto col-xl-auto col-xxl-auto flex-grow-1">
          <div className="col-12 d-flex flex-row justify-content-start align-items-center align-self-center">
            ...
            />
            <h3 className="m-0 p-0 lh-sm fs-2- font-oswald-regular- text-uppercase text-start fw-bold tx-primary-blue- le-spacing-1-">
              Cargar datos
            </h3>
          </div>
        </div>
        <div className="col-auto col-sm-auto col-md-auto col-lg-auto col-xl-auto col-xxl-auto flex-grow-1 gap-1 d-flex flex-row justify-content-end justify-content-sm-end justify-content-md-end justify-content-lg-end justify-content-xl-end justify-content-xxl-end align-items-center align-self-center mt-4 mt-sm-4 mt-md-0 mt-lg-0 mt-xl-0 mt-xxl-0">
          <div className="row g-3 g-sm-3 g-md-2 g-lg-2 g-xl-2 g-xxl-2 d-flex flex-row justify-content-center align-items-center align-self-center">
            <div className="col-auto">
              <button
                type="button"
                className="btn btn-neumorphic- btn-primary-yellow- d-flex flex-row justify-content-center align-items-center align-self-center"
              ...
              >
                <FontAwesomeIcon
                  ...
                  size="sm"
                />
                <span className="lh-1 le-spacing-05- fs-5- font-noto-regular- fw-bold">
                  Importar datos
                </span>
              </button>
            </div>
            <div className="col-auto">
              <button
                type="button"
                className="btn btn-neumorphic- btn-primary-blue- d-flex flex-row justify-content-center align-items-center align-self-center"
              >
                <i className="fa icon-download-file me-2"></i>
                <span className="lh-1 le-spacing-05- fs-5- font-noto-regular- fw-bold">
                  Descargar plantilla
                </span>
              </button>
          ...
          <form action="" className="position-relative">
            <div className="row mb-4">
              <div className="col-10 mx-auto">
                <p className="m-0 p-0 lh-sm fs-4- font-noto-regular- fw-normal tx-tertiary-black- le-spacing-05- text-align-justify-">
                  Selecciona una maquina y un proceso para aplicar el análisis
                  de predicción y clasificación de defectos.
                </p>
              </div>
            </div>
            <div className="row">
            ...
            <div className="row mb-4">
              <div className="col-10 mx-auto">
                <p className="m-0 p-0 lh-sm fs-4- font-noto-regular- fw-normal tx-tertiary-black- le-spacing-05- text-align-justify-">
                  Ingresa cada una de las siguientes variables para obtener la
                  debida caracterización de defectos.
                </p>
              </div>
            </div>
            <div className="row">
              <div className="col-10 mx-auto">
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        ...
                        id="PP_Hidro_Cemento_Kg"
                        placeholder="PP HIDRO CEMENTO (KG)"
                        name="PP_Hidro_Cemento_Kg"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Hidro_Carbonato_Kg"
                        placeholder="PP HIDRO CARBONATO (KG)"
                        name="PP_Hidro_Carbonato_Kg"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Hidro_Silice_Kg"
                        placeholder="PP HIDRO SILICE (KG)"
                        name="PP_Hidro_Silice_Kg"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Hidro_Celulosa_Kg"
                        placeholder="PP HIDRO CELULOSA (KG)"
                        name="PP_Hidro_Celulosa_Kg"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Hidro_Hidroxido_Kg"
                        placeholder="PP HIDRO HIDROXIDO (KG)"
                        name="PP_Hidro_Hidroxido_Kg"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Hidro_Bentonita_Kg"
                        placeholder="PP HIDRO BENTONITA (KG)"
                        name="PP_Hidro_Bentonita_Kg"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Hidro_SolReales_porcentage"
                        placeholder="PP HIDRO SOL REALES (%)"
                        name="PP_Hidro_SolReales_porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Hidro_CelulosaS_porcentage"
                        placeholder="PP HIDRO CELULOSA S (%)"
                        name="PP_Hidro_CelulosaS_porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Hidro_CelulosaSR_SR_grados"
                        placeholder="PP HIDRO CELULOSA SR (°)"
                        name="PP_Hidro_CelulosaSR_SR_grados"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Refi_CelulosaH_porcentage"
                        placeholder="PP REFI CELULOSA H (%)"
                        name="PP_Refi_CelulosaH_porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Refi_CelulosaS_porcentage"
                        placeholder="PP REFI CELULOSA S (%)"
                        name="PP_Refi_CelulosaS_porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Refi_CelulosaSR_SR_grados"
                        placeholder="PP REFI CELULOSA SR (°)"
                        name="PP_Refi_CelulosaSR_SR_grados"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_FlujoFloc_L_min"
                        placeholder="PP MAQ FLUJO FLOC (L/Min)"
                        name="PP_Maq_FlujoFloc_L_min"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        ...
                        className="form-control"
                        id="PP_Maq_Vueltas_N"
                        placeholder="PP MAQ VUELTAS N"
                        name="PP_Maq_Vueltas_N"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        ...
                        className="form-control"
                        id="PP_Maq_Vel_m_min"
                        placeholder="PP MAQ VEL (M/MIN)"
                        name="PP_Maq_Vel_m_min"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_FormatoP_PSI"
                        placeholder="PP MAQ FORMATO P PSI"
                        name="PP_Maq_FormatoP_PSI"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_FlujoFlocForm_L_Placa"
                        placeholder="PP MAQ FLUJO FLOC FORM (L/Placa)"
                        name="PP_Maq_FlujoFlocForm_L_Placa"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_VacíoCP_PulgadasHg"
                        placeholder="PP MAQ VACIO CP PULGADAS HG"
                        name="PP_Maq_VacíoCP_PulgadasHg"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_VacioSF_PulgadasHg "
                        placeholder="PP MAQ VACIO SF PULGADAS HG"
                        name="PP_Maq_VacioSF_PulgadasHg "
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_Recir__porcentage"
                        placeholder="PP MAQ RECIR (%)"
                        name="PP_Maq_Recir__porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_Fieltro_Dias"
                        placeholder="PP MAQ FIELTRO DÍAS"
                        name="PP_Maq_Fieltro_Dias"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_PF_Humedad__porcentage"
                        placeholder="PP PF HUMEDAD (%)"
                        name="PP_PF_Humedad__porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        ...
                        className="form-control"
                        id="PP_PF_Espesor_mm"
                        placeholder="PP PF ESPESOR (MM)"
                        name="PP_PF_Espesor_mm"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        ...
                        className="form-control"
                        id="PP_PF_Dens_g_cm3"
                        placeholder="PP PF DENS (G/CM3)"
                        name="PP_PF_Dens_g_cm3"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_FlocCanalS__porcentage"
                        placeholder="PP MAQ FLOC CANAL S (%)"
                        name="PP_Maq_FlocCanalS__porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_FlocTkS__porcentage"
                        placeholder="PP MAQ FLOC TKS (%)"
                        name="PP_Maq_FlocTkS__porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_FlocFormS__porcentage"
                        placeholder="PP MAQ FLOC FORM S (%)"
                        name="PP_Maq_FlocFormS__porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_MaqTCE_Densidad_g_cm3"
                        placeholder="PP MAQ TCE DENSIDAD (G/CM3)"
                        name="PP_MaqTCE_Densidad_g_cm3"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_TCES__porcentage"
                        placeholder="PP MAQ TCES (%)"
                        name="PP_Maq_TCES__porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_CilinS__porcentage"
                        placeholder="PP MAQ CILIN S (%)"
                        name="PP_Maq_CilinS__porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_Cono1S__porcentage"
                        placeholder="PP MAQ CONO 1S (%)"
                        name="PP_Maq_Cono1S__porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_MolinoS__porcentage"
                        placeholder="PP MAQ MOLINO S (%)"
                        name="PP_Maq_MolinoS__porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_P1H__porcentage"
                        placeholder="PP MAQ P1H (%)"
                        name="PP_Maq_P1H__porcentage"
                      />
                  ...
                  <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 mb-3 mb-sm-3 mb-md-4 mb-lg-4 mb-xl-4 mb-xxl-4">
                    <div className="form-floating">
                      <input
                        type="number"
                        className="form-control"
                        id="PP_Maq_P3H__porcentage"
                        placeholder="PP MAQ P3H (%)"
                        name="PP_Maq_P3H__porcentage"
                      />
                ...
                <div className="row gx-2 d-flex flex-row justify-content-end align-items-start align-self-start mt-2 mb-4">
                  <div className="col-12 col-sm-12 col-md-auto col-lg-auto col-xl-auto col-xxl-auto">
                    <button
                      type="button"
                      className="btn btn-neumorphic- btn-primary-blue- d-flex flex-row justify-content-center align-items-center align-self-center ps-5 pe-5"
                      onClick={toggleManualCharacterization}
                      data-bs-target="#manual-characterization"
                      aria-controls="manual-characterization"
                    >
                      <FontAwesomeIcon
                        className="me-2"
                        icon={faSpinner}
      ...
      <div
        className={`offcanvas offcanvas-bottom offcanvas-bottom- manual-characterization- ${
          showManualCharacterization ? "show" : ""
        }`}
        tabIndex="-1"
        data-bs-backdrop="false"
        id="manual-characterization"
        aria-labelledby="manual-characterization"
      ...
      >
        <div className="offcanvas-header pt-4 pb-4 ps-2 pe-2 ps-sm-2 pe-sm-2 ps-md-4 pe-md-4 ps-lg-4 pe-lg-4 ps-xl-4 pe-xl-4 ps-xxl-4 pe-xxl-4">
          ...
          <button
            type="button"
            className="ms-5 btn-close-offcanvas btn-secondary-blue-"
          ...
          <div className="container-fluid">
            <div className="row gx-4 d-flex flex-wrap flex-row flex-sm-row flex-md-row flex-lg-row flex-xl-row flex-xxl-row justify-content-between justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between align-items-center align-self-center align-self-xxl-center mt-4">
              <div className="col-auto col-sm-auto col-md-auto col-lg-auto col-xl-auto col-xxl-auto d-flex flex-column justify-content-start justify-content-sm-start justify-content-md-start justify-content-lg-start justify-content-xl-start justify-content-xxl-start align-items-center align-self-center">
                ...
                <div className="row row-cols-auto g-3 d-flex flex-wrap flex-row justify-content-start align-items-center align-self-center me-auto">
                  <div className="col-auto d-flex flex-row justify-content-start align-items-center align-self-center">
                    ...
                    <p className="m-0 p-0 lh-sm fs-5- font-noto-regular- text-start fw-bold tx-tertiary-black- le-spacing-05-">
                      Buena
                    </p>
                  </div>
                  <div className="col-auto d-flex flex-row justify-content-start align-items-center align-self-center">
              ...
              <div className="col-auto col-sm-auto col-md-auto col-lg-auto col-xl-auto col-xxl-auto d-flex flex-column justify-content-end justify-content-sm-end justify-content-md-end justify-content-lg-end justify-content-xl-end justify-content-xxl-end align-items-center align-self-center mt-3 mt-sm-0 mt-md-0 mt-lg-0 mt-xl-0 mt-xxl-0">
                ...
                <div className="row row-cols-auto g-3 d-flex flex-wrap flex-row justify-content-start align-items-center align-self-center me-auto">
                  <div className="col-auto d-flex flex-row justify-content-start align-items-center align-self-center">
                    <FontAwesomeIcon
                      className="co-primary-green- me-2"
                      icon={faCircleCheck}
                      size="lg"
                    />
                    <p className="m-0 p-0 lh-sm fs-4- font-noto-regular- text-start fw-bold tx-tertiary-black- le-spacing-05-">
                      8
                    </p>
                  </div>
                  <div className="col-auto d-flex flex-row justify-content-start align-items-center align-self-center">
                    <FontAwesomeIcon
                      className="co-primary-red- me-2"
                      icon={faCircleXmark}
                      size="lg"
                    />
                    <p className="m-0 p-0 lh-sm fs-4- font-noto-regular- text-start fw-bold tx-tertiary-black- le-spacing-05-">
            ...
            <div className="row row-cols-auto d-flex flex-wrap justify-content-center align-items-start align-self-start justify-content-sm-center align-items-sm-start align-self-sm-start justify-content-md-center align-items-md-start align-self-md-start justify-content-lg-start align-items-lg-start align-self-lg-start justify-content-xl-start align-items-xl-start align-self-xl-start justify-content-xxl-start align-items-xxl-start align-self-xxl-start g-4 mt-4">
              <div className="col d-flex flex-column justify-content-center align-items-center align-self-start wrapper-variable-card-">
                <div
                  id="variable-card"
                  className="w-100 d-flex flex-row justify-content-center align-items-center align-self-center cursor-"
                >
                  <div className="card border-0 position-relative overflow-hidden">
                    <div
                      ...
                      type="button"
                      onClick={toggleRelevanceCharacteristics}
                      data-bs-target="#relevance-characteristics"
                      aria-controls="relevance-characteristics"
                    >
                      <div className="mt-3 wrapper-name-variable-">
                        <div className="w-auto pt-1 bt-primary-red-">
                          <p className="m-0 p-0 lh-sm fs-5- font-noto-regular- text-center text-uppercase fw-bold tx-tertiary-black- le-spacing-05-">
                            Tallón
                          </p>
                        </div>
                      </div>
      ...
      <div
        className={`offcanvas offcanvas-bottom offcanvas-bottom- relevance-characteristics- ${
          showRelevanceCharacteristics ? "show" : ""
        }`}
        tabIndex="-1"
        data-bs-backdrop="false"
        id="relevance-characteristics"
        aria-labelledby="relevance-characteristics"
        data-bs-scroll="false"
      >
        <div className="offcanvas-header pt-4 pb-4 ps-2 pe-2 ps-sm-2 pe-sm-2 ps-md-4 pe-md-4 ps-lg-4 pe-lg-4 ps-xl-4 pe-xl-4 ps-xxl-4 pe-xxl-4">
          <h2 className="m-0 ms-3 me-5 p-0 lh-sm fs-2- font-oswald-regular- text-uppercase text-start fw-bold tx-primary-blue- le-spacing-1-">
        ...
        <div className="offcanvas-body ps-2 pe-2 ps-sm-2 pe-sm-2 ps-md-3 pe-md-3 ps-lg-4 pe-lg-4 ps-xl-4 pe-xl-4 ps-xxl-4 pe-xxl-4">
          <div className="container-fluid position-relative">
            <div className="row mt-4 mb-4">
              <div className="col-auto">
                <div className="w-auto pt-1 bt-primary-red-">
                  <h3 className="m-0 p-0 lh-sm fs-3- font-oswald-regular- text-uppercase text-start fw-bold tx-primary-blue- le-spacing-1-">
                    Tallon
                  </h3>
                </div>
              </div>
              ...
              <div id="relevance-chart-" className="col-12">
                <div className="wrapper-relevance-chart- w-100">
                  <div
                    ...
                    id="relevance-characteristics-chart-"
                  ></div>
                </div>
              </div>
            </div>
      ...
      <div
        className={`offcanvas offcanvas-bottom offcanvas-bottom- import-characterization- ${
          showImportCharacterization ? "show" : ""
        }`}
        tabIndex="-1"
        data-bs-backdrop="false"
        id="import-characterization"
        aria-labelledby="import-characterization"
        data-bs-scroll="false"
      >
        <div className="offcanvas-header pt-4 pb-4 ps-2 pe-2 ps-sm-2 pe-sm-2 ps-md-4 pe-md-4 ps-lg-4 pe-lg-4 ps-xl-4 pe-xl-4 ps-xxl-4 pe-xxl-4">
          <h2 className="m-0 ms-3 me-5 p-0 lh-sm fs-2- font-oswald-regular- text-uppercase text-start fw-bold tx-primary-blue- le-spacing-1-">
          ...
          <button
            ...
            className="ms-5 btn-close-offcanvas btn-secondary-blue-"
            data-bs-dismiss="offcanvas"
            onClick={toggleImportCharacterization}
          >
            <FontAwesomeIcon icon={faXmark} size="lg" />
          </button>
        </div>
          ...
          <div className="container-fluid position-relative">
            <div className="row mt-4 mb-4">
              <div className="col-12">
                <form
                  action=""
                  className="position-relative wrapper-search- d-block d-sm-block d-md-block d-lg-block d-xl-block d-xxl-block"
                >
                ...
                <nav>
                  <ul className="pagination justify-content-center">
                    ...
                    <li className="page-item">
                      ...
                      >
                        <i className="fa icon-arrow-right"></i>
                      </button>
                    </li>
                  </ul>
                </nav>
      ...
      <div
        className="modal animated fade fast"
        id="upload-file"
        tabIndex="-1"
        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content p-0 ps-4 pe-4">
            <div className="modal-header">
              <button
                type="button"
                className="btn-close btn-secondary-blue-"
            ...
            <div className="modal-body position-relative">
              <div className="row">
                <div className="col-12">
                  <h3 className="m-0 p-0 lh-sm fs-3- font-oswald-regular- text-uppercase text-start fw-bold tx-primary-blue- le-spacing-1- text-center">
                    ¡Subir archivo!
                  </h3>
                </div>
              </div>
              <div className="row mt-2">
                <div className="col-12">
                  <p className="m-0 p-0 lh-sm fs-5- font-noto-regular- fw-normal tx-primary-blue- le-spacing-05- text-center">
                    Adjunta el archivo para realizar la predicción de fallas.
                  </p>
                </div>
              </div>
              <div className="row mt-4 mb-3">
                <div className="col-12">
                  <form
                    id="internal-form"
                    className='w-100" autocomplete="nope'
                  >
                    <div className="row g-0 g-sm-0 g-md-2 g-lg-2 g-xl-2 g-xxl-2">
                      <div className="col-12 d-flex flex-column justify-content-center align-items-center align-self-center">
                        <div
                          id="test-drop-area"
                          className="file-drop-area- position-relative overflow-hidden"
                        >
                          <img
                            className="card-img position-absolute top-50 start-50 translate-middle"
                            src={DropArea}
                            alt=""
                          />
                          <div className="d-flex flex-column justify-content-center align-items-center align-self-center w-100 text-wrap p-3">
                            <img
                              className="image-upload- mx-auto mb-4"
                              src={UploadIcon}
                              alt=""
                            />
                            <p className="mb-1 p-0 lh-sm text-center fs-5- font-noto-regular- fw-normal tx--quaternary-gray-">
                              Arrastre y suelte el archivo aquí
                            </p>
                            <p className="m-0 p-0 lh-sm text-center fs-5- font-noto-regular- fw-normal tx-black-">
                              o{" "}
                              <span className="tx-secondary-blue-">
              ...
              <div className="row">
                <div className="col-12">
                  <p className="m-0 p-0 lh-sm text-center fs-6- font-noto-regular- fw-normal tx--quaternary-gray-">
                    Nombre del archivo: Lote_22_01_2024.csv
                  </p>
                </div>
              </div>
              <div className="row mt-2">
                <div className="col-12">
                  <p className="m-0 p-0 lh-sm text-center fs-6- font-noto-regular- fw-normal tx-black-">
                    Tipo de archivos permitidos: excel, csv y txt
                  </p>
                </div>
              </div>
              <div className="row gx-2 d-flex flex-row justify-content-center align-items-start align-self-start mt-4 mb-2">
                <div className="col-auto">
                  <button
                    ...
                    className="btn btn-neumorphic- btn-primary-blue- d-flex flex-row justify-content-center align-items-center align-self-center ps-5 pe-5"
                    onClick={toggleImportCharacterization}
                    data-bs-target="#import-characterization"
                    aria-controls="import-characterization"
                  >
                    <FontAwesomeIcon
                      className="me-2"
                      icon={faArrowUpFromBracket}
