...
export default function DataHistory() {
  ...
  const [typeModelHistory, setModelHistory] = useState(
        ...
        <div className="col-auto">
          <div className="w-auto">
            <input
              type="radio"
              className="btn-check"
              name="options-table-models"
              id="table-type-machine-learning-model"
              checked={typeModelHistory === "machine_learning_model"}
              onChange={() => changeRadioModelHistory("machine_learning_model")}
            />
            <label
              className="btn rounded-pill d-flex flex-row justify-content-center align-items-center align-self-center btn-transparent- btn-radio- bs-1- ps-4 pe-4 pt-3 pb-3"
              htmlFor="table-type-machine-learning-model"
            >
              <i className="fa icon-machine-learning me-2"></i>
              <span>Modelo de Aprendizaje automático</span>
            </label>
          </div>
        </div>
        <div className="col-auto">
          <div className="w-auto">
            <input
              ...
              className="btn-check"
              name="options-table-models"
              id="table-type-computer-vision-model"
              checked={typeModelHistory === "computer_vision_model"}
              onChange={() => changeRadioModelHistory("computer_vision_model")}
            />
            <label
              className="btn rounded-pill d-flex flex-row justify-content-center align-items-center align-self-center btn-radio- bs-1- ps-4 pe-4 pt-3 pb-3"
              htmlFor="table-type-computer-vision-model"
            >
              <i className="fa icon-computer-vision me-2"></i>
              <span>Modelo de Visión por computador</span>
            </label>
          </div>
        </div>
      </div>
        ...
        <>
          <div className="row gx-4 d-flex flex-wrap flex-row flex-sm-row flex-md-row flex-lg-row flex-xl-row flex-xxl-row justify-content-between justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between justify-content-xxl-between align-items-center align-self-center align-self-xxl-center mt-5 mb-4 mb-sm-4 mb-md-5 mb-lg-5 mb-xl-5 mb-xxl-5 ms-1 me-1 ms-sm-1 me-sm-1 ms-md-1 me-md-1 ms-lg-1 me-lg-1 ms-xl-1 me-xl-1 ms-xxl-1 me-xxl-1">
            ...
            <div className="col-12 col-sm-12 col-md-auto col-lg-auto col-xl-auto col-xxl-auto d-flex flex-row justify-content-end justify-content-sm-end justify-content-md-end justify-content-lg-end justify-content-xl-end justify-content-xxl-end align-items-center align-self-center mt-4 mt-sm-4 mt-md-0 mt-lg-0 mt-xl-0 mt-xxl-0">
              <div
                id="internal-form"
                className="col-12 col-sm-12 col-md-auto col-lg-auto col-xl-auto col-xxl-auto"
              >
                <div className="form-floating inner-addon- left-addon-">
                  ...
                  <label className="fs-5- ff-monse-regular-">
                    Rango de fecha
                  </label>
                </div>
              </div>
                  ...
                  <thead>
                    <tr>
                      <th
                        scope="col"
                        rowSpan="2"
                        className="th-width-xs- no-relevance- align-middle"
                      >
                        <div className="d-flex flex-row justify-content-center align-items-center align-self-center w-100">
                          <div className="w-auto d-flex flex-row justify-content-center align-items-center align-self-center">
                            <div className="checks-radios-">
                      ...
                      <th
                        scope="col"
                        rowSpan="2"
                        className="th-width-sm- no-relevance- align-middle"
                      >
                        <div className="d-flex flex-row justify-content-center align-items-center align-self-center w-100">
                          <span className="fs-6-">
                      ...
                      <th
                        scope="col"
                        colSpan="11"
                        className="th-width-auto-  relevance- align-middle"
                      >
                        <div className="d-flex flex-row justify-content-center align-items-center align-self-center w-100">
                          <span className="fs-6-">
                    ...
                    <tr>
                      <th
                        scope="col"
                        className="th-width-xxs- relevance- align-middle"
                      >
                        <div className="d-flex flex-row justify-content-center align-items-center align-self-center w-100">
